    ...
    <section class="brand_area section_gap_bottom">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-down" data-aos-easing="linear"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-right" data-aos-easing="linear"
                            data-aos-duration="1500">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-easing="linear"
                            data-aos-duration="1500">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-left" data-aos-easing="linear"
                            data-aos-duration="1500">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-up" data-aos-easing="linear"
                            data-aos-duration="1500">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">

    ...
    <section class="blog_categorie_area section_gap_top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        <img src="{{ asset('assets/img/blog/cat-post/cat-post-2.jpg') }}" alt="post">
                        <div class="categories_details">
                            <div class="categories_text">
                                <a href="single-blog.html">
                                    <h5>Politics</h5>
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        <img src="{{ asset('assets/img/blog/cat-post/cat-post-1.jpg') }}" alt="post">
                        <div class="categories_details">
                            <div class="categories_text">
                                <a href="single-blog.html">
                                    <h5>Food</h5>
                ...
                <div class="col-lg-8">
                    <div class="blog_left_sidebar">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('assets/img/blog/main-blog/m-blog-2.jpg') }}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('assets/img/blog/main-blog/m-blog-3.jpg') }}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('assets/img/blog/main-blog/m-blog-4.jpg') }}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                                            <h2>The Night Sky</h2>
                                        </a>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('assets/img/blog/main-blog/m-blog-5.jpg') }}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget author_widget">
                            <img class="author_img rounded-circle" src="{{ asset('assets/img/blog/author.png') }}"
                                alt="">
